...
TOEIC 시험 대비용 단어/숙어 정리 및 이해도 진행 상황 확인 페이지.
...
- **자가 테스트**: 카드 형태로 단어를 한 개씩 보여줍니다. 단어만 보고 뜻을 떠올려본 뒤 "정답 보기"로 확인하고, 스스로 "모르겠음/애매함/알고 있음"으로 평가하면 그 결과가 바로 이해도 상태에 반영됩니다. 기본적으로 "이해함" 항목은 제외하고 미숙지·학습중 항목만 순서를 섞어서 테스트합니다.
- **진행 상황** 탭에서 등록 개수와 이해도 비율 확인
...
- Datamuse도 영어 사전 기반이라 숙어나 전문 용어는 검색이 안 될 수 있습니다.
...
- 실제 TOEIC 기출문제는 ETS 저작권 때문에 재현하거나 비슷하게 생성해 제공하지 않습니다. 대신 등록한 단어로 직접 복습할 수 있는 카드형 자가 테스트를 제공합니다.
